	...
	trends: [
		{
			...
			source:
				'https://www.youtube.com/watch?v=p30rc_-bTLs&list=RDp30rc_-bTLs&start_radio=1',
		},
		{
			id: 3,
			slug: 'tvshow-3',
...
/* Para crear un Store necesitamos llamar a la función createStore del paquete
 de redux pasándole los parámetros del reducer y initialState.

Para conectar un componente a Redux vamos a necesitar importar connect de 
react-redux, connect va a aceptar dos parámetros:

mapStateToProps: es una función que le va a indicar al provider qué información 
